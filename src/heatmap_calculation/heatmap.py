...
file_path = "/home/freystec/SiMo_yolov11n_imgsz_640_long_tracked_data.json"
save_path = "/home/freystec/foosball-statistics/src/heatmap_calculation/SiMo_yolov11n_imgsz_640_long_tracked_data.jpg"
...
fig, ax = plt.subplots(figsize=(resolution_x / 100, resolution_y / 100), dpi=100)

# Plot the heat map on the axes
ax.imshow(heatmap_log, cmap='hot', interpolation='nearest', extent=[0, resolution_x, resolution_y, 0])

# Turn off the axes
ax.set_axis_off()

# Save the figure with a tight layout to remove whitespace
